...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_attributes=4, zero_init_residual=False):
        ...
        self.classifier = nn.Sequential(fc_block(512, 256), nn.Linear(256, num_attributes))  # 修改输出层
